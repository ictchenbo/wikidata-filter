...
from wikidata_filter.integrations.unstructured.html_table import HtmlCell, HtmlRow, HtmlTable
...
from wikidata_filter.integrations.unstructured.utils import lazyproperty
