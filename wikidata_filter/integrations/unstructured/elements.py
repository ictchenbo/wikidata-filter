...
from .constants import UNSTRUCTURED_INCLUDE_DEBUG_METADATA
from .utils import get_call_args_applying_defaults, lazyproperty
...
class ElementMetadata:
    ...
    def from_dict(cls, meta_dict: dict[str, Any]) -> ElementMetadata:
        ...
        """
        from .staging import elements_from_base64_gzipped_json
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        `None`.
        """
        from .staging import elements_to_base64_gzipped_json
...
def _kvform_rehydrate_internal_elements(kv_pairs: list[dict[str, Any]]) -> list[FormKeyValuePair]:
    ...
    """
    from .staging import elements_from_dicts
